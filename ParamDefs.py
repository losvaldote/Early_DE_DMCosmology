...
#Parametro de masa par el modelo owa0CDMCosmology_modified.
ms_par = Parameter("ms", 1E3, 0.1, (0,1E4), "ms")

#Parametro de ecuacion de estado de DM en el modelo EKCDMCosmology.
#Parametro de ecuacion de estado de DM en el modelo Early_DE_DMCosmology.
wMO_par = Parameter("wMO",0.0, 0.1, (-1.0,1.0), "w_{MO}")
